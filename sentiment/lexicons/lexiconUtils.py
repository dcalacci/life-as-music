#/usr/bin/env python
from config import liwc_dir, pitt_dir, liu_dir
from stemming.porter2 import stem
import os

liwcfile = os.path.join(liwc_dir, "features.txt")
liwc_categoryfile = os.path.join(liwc_dir, "categories.txt")
...
class Lexicons:
    def __init__(self):
        ...
        self.liwc_categories = open(fpath, 'rb').read().splitlines()
...
class LiwcDict:
    def __init__(self, filepath=liwcfile):
        ...
        self.wordmap = {}
        self.categories = open(liwc_categoryfile, 'rb').read().splitlines()
